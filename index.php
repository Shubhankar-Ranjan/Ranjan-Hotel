...
<body class="bg-light">
            ...
            <?php
                ...
                while($room_data = mysqli_fetch_assoc($room_res))
                {
                    ...
                    if(!$settings_r['shutdown']){
                        ...
                        $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' href='#'m class='btn btn-sm text-white custom-bg shadow-none'>Book Now</button>";
                    }
    ...
    <div class="container">
        ...
        <?php
                ...
                while($row = mysqli_fetch_assoc($res)){
                    echo <<<data
                        <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3 me-3">
