<?php
    ...
    { 
        ...
        $query = "SELECT bo.*, bd.* FROM `booking_order` bo INNER JOIN `booking_details` bd ON bo.booking_id = bd.booking_id WHERE(bo.arrival=1 OR bo.refund=1) AND (bd.phonenum LIKE ? OR bd.user_name LIKE ?) ORDER BY bo.booking_id DESC";
        ...
        while($data = mysqli_fetch_assoc($limit_res))
        {
            ...
            $table_data .="
                <tr>
                    ...
                    <td>
                        <button type='button' onclick='download($data[booking_id])' class='btn btn-success btn-sm fw-bold shadow-none mt-2'>
